    ...
    <div className="parkrun-page">
      ...
      {stats && (
        <div className="stats-grid">
          ...
          {stats.fastestTime && (
            <div className="stat-card">
              <div className="stat-value">{stats.fastestTime.time_string}</div>
              <div className="stat-label">
                Fastest Time - {stats.fastestTime.athlete_name}
              </div>
            </div>
          )}
        </div>
                ...
                {results.map(result => (
                  <tr key={result.id}>
                    ...
                    <td>
                      ...
                      <div className="event-number">#{result.event_number}</div>
                    </td>
                    ...
                    <td className="age-grade">{result.age_grade || '-'}</td>
                    <td className="age-category">{result.age_category || '-'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
