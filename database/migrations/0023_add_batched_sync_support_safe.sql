-- WOOD-8: Safe version - only creates what doesn't exist yet
-- This skips the ALTER TABLE commands since those columns already exist

-- Create sync_batches table (safe to re-run with IF NOT EXISTS)
...
-- Indexes for efficient batch queries (safe to re-run with IF NOT EXISTS)
