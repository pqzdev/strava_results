...
CREATE INDEX idx_manual_submissions_session ON manual_submissions(submission_session_id);
CREATE INDEX idx_manual_submissions_status ON manual_submissions(status);
CREATE INDEX idx_manual_submissions_strava_id ON manual_submissions(strava_activity_id);
